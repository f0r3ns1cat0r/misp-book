...
If you try to add a second, conflicting tag from an exclusive taxonomy or predicate, MISP warns
you of the conflict rather than applying it. Exclusivity is defined in the taxonomy's JSON, not
toggled from the UI.
