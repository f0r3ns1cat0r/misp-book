...
::: {.callout-warning}
You need to have a specific role to manage Galaxies on a MISP instance.
:::
...
::: {.callout-warning}
This will impact the UI "Update MISP" functionality in administration. Your git head might get [detached](https://git-scm.com/docs/gitglossary#gitglossary-aiddefdetachedHEADadetachedHEAD) in your misp-galaxy repo.
:::
